...
async function main() {
  ...
  const productsData = [
    ...
    {
      id: "02724639",
      // Corregido categoryId: "189-30-302-501" según tabla
      categoryId: "189-30-302-501",
      name: "Pullover de Niño",
      costPrice: 1200,
      salePrice: 1500,
    ...
    },
    {
      id: "015456",
      categoryId: "189-30-304-501",
      name: "Pantalon Sudadera de Mujer Shein",
      costPrice: 1900,
      salePrice: 2375,
      unit: "un",
    },
  ...
  if (almacen) {
    const almacenInventoryData = [
      ...
      { warehouseId: almacen.id, productId: "015160", quantity: 5 },
  ...
  if (terminal) {
    const terminalInventoryData = [
      ...
      { salesAreaId: terminal.id, productId: "015067", quantity: 25 },
