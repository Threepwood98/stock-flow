  ...
  if (almacen) {
    await prisma.warehouseInventory.createMany({
      data: [
        ...
        { warehouseId: almacen.id, productId: "015602", quantity: 359 },
        { warehouseId: almacen.id, productId: "015602", quantity: 167 },
        { warehouseId: almacen.id, productId: "015602", quantity: 500 },
        { warehouseId: almacen.id, productId: "015603", quantity: 500 },
        { warehouseId: almacen.id, productId: "015603", quantity: 295 },
        { warehouseId: almacen.id, productId: "015604", quantity: 100 },
        { warehouseId: almacen.id, productId: "015604", quantity: 500 },
        ...
        { warehouseId: almacen.id, productId: "015489", quantity: 25 },
        { warehouseId: almacen.id, productId: "015489", quantity: 5 },
        ...
        { warehouseId: almacen.id, productId: "04400224", quantity: 264 },
        { warehouseId: almacen.id, productId: "04400224", quantity: 360 },
        ...
        { warehouseId: almacen.id, productId: "015610", quantity: 200 },
        { warehouseId: almacen.id, productId: "015610", quantity: 40 },
  ...
  if (glorieta) {
    await prisma.salesAreaInventory.createMany({
      data: [
        ...
        { salesAreaId: glorieta.id, productId: "015602", quantity: 141 },
        { salesAreaId: glorieta.id, productId: "015602", quantity: 39 },
